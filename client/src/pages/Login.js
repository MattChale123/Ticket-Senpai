      ...
      <div style={{ 
        ...
        height: '1100px'
            ...
            <div style={styling}>
              ...
              <br />
              <p style={{display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'black'}} className="login-font">If you haven't registered, click <Link to={'/register'}>here</Link></p>
